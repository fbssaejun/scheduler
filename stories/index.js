...
//Dalist Story Fake data
  ...
  storiesOf("InterviewerList", module)
    ...
    .add("Edit", () => <Form name="Some Name" interviewers={interviewers} interviewer={3} onSave={action("onSave")} onCancel={action("onCancel")} />)
